function [curr_dat1_sz,curr_dat2_sz, curr_lab_sz] = store2hdf5_chroma(filename, data1,data2, labels, create, startloc, chunksz)  
  ...
  if create
    ...
    h5create(filename, '/data1', [dat_dims1(1:end-1) Inf], 'Datatype', 'single', 'ChunkSize', [dat_dims1(1:end-1) chunksz]); % width, height, channels, number 
